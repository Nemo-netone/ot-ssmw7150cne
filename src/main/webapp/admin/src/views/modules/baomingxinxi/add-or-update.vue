	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="报名人数" prop="kecanyurenshu" >
					<el-select :disabled="ro.kecanyurenshu" v-model.number="ruleForm.kecanyurenshu" placeholder="请选择报名人数" >
						<el-option
				...
				<el-form-item v-else class="input" label="报名人数" prop="kecanyurenshu" >
					<el-input v-model="ruleForm.kecanyurenshu"
		...
		methods: {
			...
			async onSubmit() {
					...
					if(objcross!=null) {
						...
						objcross.kecanyurenshu = objcross.kecanyurenshu - this.ruleForm.kecanyurenshu
						if(objcross.kecanyurenshu<0){
