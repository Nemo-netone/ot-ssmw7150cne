	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="详细住址" prop="xiangxizhuzhi" >
					<el-input v-model="ruleForm.xiangxizhuzhi" placeholder="详细住址" clearable  :readonly="ro.xiangxizhuzhi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="详细住址" prop="xiangxizhuzhi" >
					<el-input v-model="ruleForm.xiangxizhuzhi" placeholder="详细住址" readonly></el-input>
				</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='xiangxizhuzhi'){
							this.ruleForm.xiangxizhuzhi = obj[o];
							this.ro.xiangxizhuzhi = true;
							continue;
						}
						if(o=='touxiang'){
