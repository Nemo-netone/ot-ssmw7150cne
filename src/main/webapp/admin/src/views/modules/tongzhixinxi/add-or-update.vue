	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="通知标题" prop="tongzhibiaoti" >
				...
				<el-form-item class="input" v-else-if="ruleForm.tongzhishijian" label="通知时间" prop="tongzhishijian" >
			...
			<el-form-item v-else-if="ruleForm.tongzhineirong" label="通知内容" prop="tongzhineirong" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.tongzhineirong"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.tongzhineirong = this.ruleForm.tongzhineirong.replace(reg,'../../../ssmw7150cne/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
