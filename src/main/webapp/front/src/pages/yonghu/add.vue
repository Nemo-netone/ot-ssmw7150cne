<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="详细住址" prop="xiangxizhuzhi">
				<el-input v-model="ruleForm.xiangxizhuzhi" 
					placeholder="详细住址" clearable :disabled=" false  ||ro.xiangxizhuzhi"></el-input>
			</el-form-item>
