<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="可参与人数" prop="kecanyurenshu">
				<el-input v-model.number="ruleForm.kecanyurenshu" 
					placeholder="可参与人数" clearable :disabled=" false  ||ro.kecanyurenshu"></el-input>
			</el-form-item>
