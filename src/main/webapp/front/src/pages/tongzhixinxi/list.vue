	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					<el-input v-model="formSearch.tongzhibiaoti" placeholder="通知标题" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
			...
			<div class="list">
				...
				<div class="list1 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
						...
						<div class="name">{{item.tongzhibiaoti}}</div>
						<div class="time_item">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.tongzhibiaoti != '') searchWhere.tongzhibiaoti = '%' + this.formSearch.tongzhibiaoti + '%';
