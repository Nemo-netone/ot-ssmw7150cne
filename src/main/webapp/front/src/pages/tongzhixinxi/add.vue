<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="通知标题" prop="tongzhibiaoti">
			...
			<el-form-item class="add-item" label="通知时间" prop="tongzhishijian">
				<el-date-picker
			...
			<el-form-item class="add-item" label="通知内容" prop="tongzhineirong">
				<editor 
